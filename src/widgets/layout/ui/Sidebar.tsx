...
// Ссылка с учетом состояния сворачивания и локализации
...
// Секция с локализованным заголовком
...
export const Sidebar = () => {
    ...
    // Вспомогательная функция для условий перевода (если ключа нет в i18n.ts, используем фолбек)
