                ...
                {events.map((event) => (
                    <div key={event.id} className="relative pl-12 pb-10 last:pb-0 group">
                        <div className="absolute left-0 top-1 w-[40px] h-[40px] flex items-center justify-center">
                            <div
                                className="w-2.5 h-2.5 rounded-full bg-background border-2 border-primary z-10 ring-4 ring-background"/>
                        </div>

                        <Card variant="flat" padding="none" className="space-y-3">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                <span
                                    className="text-[10px] font-accent font-bold uppercase tracking-widest text-muted-foreground flex items-center gap-1.5">
